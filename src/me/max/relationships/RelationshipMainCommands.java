...
public class RelationshipMainCommands implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof ConsoleCommandSender) {
            ...
            if (((args.length == 0))) {
                if (!(p.hasPermission("relationships.main"))){
            ...
            } else if ((args[0].equalsIgnoreCase("help")) && (args[1].equalsIgnoreCase("friend"))) {
            ...
            } else if (((args[0].equalsIgnoreCase("help")) && (args[1].equalsIgnoreCase("marriage")))) {
                if (!(p.hasPermission("relationships.help.marriage"))){
                    sender.sendMessage(ChatColor.RED + "You don't have permission for this command!");
                    return true;
                }
                if (p.hasPermission("relationships.help.marriage")) {
            ...
            } else if (((args[0].equalsIgnoreCase("help")) && (args[1].equalsIgnoreCase("love")))) {
                if (!(p.hasPermission("relationships.help.love"))) {
                    sender.sendMessage(ChatColor.RED + "You don't have permission for this command!");
                    return true;
                }
                if (p.hasPermission("relationships.help.love")) {
